...
guide = "سلام , به فوتبال یار خوش امدید \n برای دریافت نتایج تیم های مورد نظر تون رو به صورت تیم۱!تیم۲ ارسال کنید\n برای دریافت اخبار روز کلمه اخبار و برای جستجو در خبر ها عبارت مد نظر خودتون برای جستجو رو به صورت اخبار:عبارت شما ارسال نمایید.\n برای مشاهده لیگ های امروز کلمه امروز و برای مشاهده بازی های آن لیگ کلمه امروز:شماره لیگ را ارسال کنید. (برای دیروز و فردا هم به همین صورت است)\n برای دسترسی به چت جی پی تی هم دستور چت:پیام مورد نظر را ارسال کنید.\n با تشکر از همراهی شما"
